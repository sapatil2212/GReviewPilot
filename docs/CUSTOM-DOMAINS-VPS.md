...
| `npm run verify:site-render` | renders every section preset and all 15 industry sites through the real renderer: nothing invisible, no blank bands, width-capped blocks centred, no overflow traps. No database needed |
